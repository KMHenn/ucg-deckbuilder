    ...
    return (
        ...
        <NumberField.Root id={id} defaultValue={0} min={min} max={max} className="flex flex-col items-start gap-1">
          ...
          <NumberField.Group className="flex">
              ...
              <NumberField.Input className="bg-white h-10 w-24 border-t border-b border-gray-200 text-center text-base text-gray-900 tabular-nums focus:z-1 focus:outline focus:outline-2 focus:-outline-offset-1 focus:outline-blue-800" />
